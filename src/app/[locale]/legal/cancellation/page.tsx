...
export default function CancellationPage() {
  ...
  const sections = [
    { title: t("cancellation.section1Title"), content: t("cancellation.section1Content") },
    { title: t("cancellation.section2Title"), content: t("cancellation.section2Content") },
    { title: t("cancellation.section3Title"), content: t("cancellation.section3Content") },
    { title: t("cancellation.section4Title"), content: t("cancellation.section4Content") },
    { title: t("cancellation.section5Title"), content: t("cancellation.section5Content") },
    { title: t("cancellation.section6Title"), content: t("cancellation.section6Content") },
  ];
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <FadeInUp delay={0.1}>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="display-md">{t("cancellation.title")}</h1>
