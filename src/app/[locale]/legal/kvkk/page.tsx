        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <FadeInUp delay={0.1}>
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="display-md">{t("kvkk.title")}</h1>
              ...
              <FadeInUp key={i} delay={0.2 + i * 0.05}>
                <div className="glass rounded-2xl p-6">
                  <h2 className="text-base font-bold mb-3 flex items-center gap-3">
                    <div className="w-7 h-7 rounded-lg bg-green-500/10 flex items-center justify-center text-xs font-bold text-green-400">
                      {i + 1}
                    </div>
                    {section.title}
                  </h2>
